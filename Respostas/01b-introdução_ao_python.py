...
def contem(lista, item_procurado):
    ...
    """
    #lista = lista.find(item_procurado)
    # return lista
...
def conta(lista, item_procurado):
    ...
    """
    resultado = lista.count(item_procurado)
    return resultado
...
def media_temperaturas(temperaturas):
    ...
    """
    temperaturas_soma = sum(temperaturas)
    quantidade = len(temperaturas)
    return temperaturas_soma / quantidade
